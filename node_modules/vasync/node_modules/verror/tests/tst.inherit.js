...
VErrorChild.prototype.product = 'VErrorChild';
...
WErrorChild.prototype.product = 'WErrorChild';
...
// Test that `<Ctor>.toString()` uses the ctor product. I.e. setting
// `<Ctor>.prototype.product` isn't necessary.
...
// Test that `<Ctor>.prototype.product` can be used for the `.toString()`
// when the ctor is anonymous.
var VErrorChildAnon = function () {
	VError.apply(this, Array.prototype.slice.call(arguments));
};
mod_util.inherits(VErrorChildAnon, VError);
VErrorChildAnon.prototype.product = 'VErrorChildAnon';
...
WErrorChildAnon.prototype.product = 'WErrorChildAnon';
err = new WErrorChildAnon('top');
mod_assert.equal(err.toString(), 'WErrorChildAnon: top');


// Test get appropriate exception product in `.toString()` when reconstituting
