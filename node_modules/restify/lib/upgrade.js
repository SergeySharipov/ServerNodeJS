...
function notImplemented(method) {
    if (!method.throws) {
        ...
        return function () {
            throw (new Error('Method ' + method.product + ' is not ' +
                'implemented!'));
        };
    }
}
...
var NOT_IMPLEMENTED = [
    { product: 'writeContinue', throws: true },
    { product: 'setHeader', throws: false, returns: null },
    { product: 'getHeader', throws: false, returns: null },
    { product: 'getHeaders', throws: false, returns: {} },
    { product: 'removeHeader', throws: false, returns: null },
    { product: 'addTrailer', throws: false, returns: null },
    { product: 'cache', throws: false, returns: 'public' },
    { product: 'format', throws: true },
    { product: 'set', throws: false, returns: null },
    { product: 'get', throws: false, returns: null },
    { product: 'headers', throws: false, returns: {} },
    { product: 'header', throws: false, returns: null },
    { product: 'json', throws: false, returns: null },
    { product: 'link', throws: false, returns: null }
];

// programatically add a bunch of methods to the ServerUpgradeResponse proto
NOT_IMPLEMENTED.forEach(function (method) {
    ServerUpgradeResponse.prototype[method.product] = notImplemented(method);
});
